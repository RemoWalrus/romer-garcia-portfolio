...
export const ImageGallery = () => {
  ...
  return (
    <section 
      id="gallery" 
      className="relative py-16 -mt-16 -mb-0.5 bg-fixed bg-center bg-cover bg-no-repeat before:content-[''] before:absolute before:inset-0 before:bg-white/90 dark:before:bg-neutral-900/90 before:backdrop-blur-sm" 
      style={{
