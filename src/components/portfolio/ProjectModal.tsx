        ...
        <div className="flex flex-col md:flex-row h-full w-full overflow-hidden" itemScope itemType="https://schema.org/CreativeWork">
          <div className="md:w-2/5 px-4 py-3 md:p-8 lg:p-12 overflow-y-auto w-full">
            <DialogHeader className="text-left">
              <div className="-mb-1.5 md:-mb-1 lg:-mb-0.5">
              ...
              <DialogTitle className="text-xl md:text-2xl lg:text-3xl font-roc font-extralight mb-[1.5em] lg:mb-[3.5em] uppercase mt-0" style={{ lineHeight: '0.95' }} itemProp="name">
                {project.title}
              </DialogTitle>
            </DialogHeader>
            ...
            <DialogDescription className="mt-1.5 md:mt-2 lg:mt-5 text-neutral-600 dark:text-neutral-400 font-arial mb-2 md:mb-6 text-xs md:text-sm lg:text-base text-left flex flex-col gap-[0.55em]" itemProp="description" style={{ lineHeight: '1.35' }}>
