...
export const CHARACTERS: ReverbCharacter[] = [
  ...
  },
  {
    ...
    figure: reverbImage("reverb-eduq-main-2026.webp"),
    accent: "#b6f13b",
  ...
  },
  {
    ...
    name: "Spark",
    role: "Demolitions / Close-Quarters / Runner",
    quote: "\u201cStill here. Still louder.\u201d",
    caption: "After the accident. Same fire, rebuilt.",
    image: reverbImage("reverb-spark-20-main.webp"),
    figure: reverbImage("reverb-spark-20-main.webp"),
    accent: "#ff2e88",
    glow: "rgba(255,46,136,0.55)",
    hasProfile: true,
    hidden: true,
    ...
    discipline: "Demolitions // Post-Incident Configuration",
    identity: [
      { label: "Real Name", value: "Spark" },
      { label: "Age", value: "20" },
      { label: "Origin", value: "Porvoo, Finland" },
      { label: "Status", value: "Post-Incident / Recovered" },
      { label: "Role", value: "Demolitions / Close-Quarters / Runner" },
      { label: "Affiliation", value: "Reverb Collective" },
    ],
    notes: [
      "LOUD / RELENTLESS / UNBOWED",
      "LEARNED PATIENCE THE HARD WAY",
      "TREATS THE PROSTHETIC AS PART OF HER",
      "PROTECTIVE TO THE POINT OF RECKLESS",
      "REFUSES TO BE TREATED CAREFULLY",
    ],
    colorName: "Hot Pink",
    specialties: [
      "Demolitions",
    ...
    palette: ["#0a0a0c", "#1d1116", "#ff2e88", "#ff6bb0", "#f2f2f4"],
    gear: [
      "Eduq-Built Prosthetic Left Arm",
      "Strap Harness",
      "Demolition Kit",
      "Fingerless Glove (Right)",
      "Signal-Pink Runners",
    ],
    overview: [
      "One year after the accident, Spark is twenty and short one arm\u2014the left one, lost in the incident that changed the collective for good.",
      "The prosthetic that replaced it is Eduq's first real answer to a problem existing technology could not solve. Building it pulled him past the edge of what anyone had made before, and it is the seed of everything the Paradoxxiaverse eventually becomes.",
      "Spark treats it like she treats everything else: hers, and loud. Recovery did not make her careful. It made her deliberate\u2014still first to move, but now she knows exactly what it costs.",
    ],
    signOff: "SAME FIRE. NEW HARDWARE. REVERB.",
    gallery: [],
  },
];
