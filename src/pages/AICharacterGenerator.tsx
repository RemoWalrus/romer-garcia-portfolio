  ...
  const generateCharacter = async () => {
    ...
    try {
      ...
      const androidFaceDescription = gender === "other"
        ? (isAristocratic 
          ? "This is an ARISTOCRATIC synthetic android with a highly refined, elegant appearance. The android has smooth PLASTIC SYNTHETIC limbs with a matte or satin finish (NOT metallic - think high-grade polymer, resin, or advanced composite materials in off-white, ivory, or pale gray tones). The face plate is COMPLETELY EMOTIONLESS AND BLANK - a smooth, featureless porcelain-white or pale synthetic surface with MINIMAL features: simple geometric eye sockets with soft neon blue glow, NO expressive mouth or nose details, NO human-like expressions. The face is serene, mask-like, and devoid of emotion - like a pristine mannequin or classical statue. Body construction is sleek plastic and synthetic polymers with graceful, refined proportions. " + (Math.random() > 0.5 ? "Synthetic fiber strands or smooth cap-like head design." : "Sleek synthetic hair in an elegant style.") + " The overall aesthetic is clean, minimalist, and eerily calm - more like a beautiful lifeless doll than a machine."
          : "This is a sleek synthetic android with smooth, artificial appearance rather than mechanical or robotic. This synthetic android has an androgynous humanoid form with a distinctive PURE WHITE, PALE, PORCELAIN-LIKE face plate made of 1-4 smooth panels (NO warm tones, NO golden/bronze hues - only cool white/pale colors). The face is VERY HUMAN-LIKE with realistic sculpted features: a prominent nose, defined cheekbones, subtle lips/mouth, and expressive contours that closely mimic human facial structure. The android has neon blue illuminated cybernetic eyes that glow softly. Body/armor is COOL METALLIC - silver, chrome, steel, gunmetal tones (NO golden or bronze colors). " + (Math.random() > 0.5 ? "Synthetic hair that looks remarkably real cascades from the head area." : "Sleek fiber-optic cables styled like hair strands are integrated into the head design.") + " The body is synthetic with clean panels and seamless construction - no exposed gears or obvious mechanical parts, more like a high-tech mannequin with advanced materials.")
        : (isAristocratic
          ? "This is an ARISTOCRATIC synthetic android with a highly refined, elegant appearance. The android has smooth PLASTIC SYNTHETIC limbs with a matte or satin finish (NOT metallic - think high-grade polymer, resin, or advanced composite materials in off-white, ivory, or pale gray tones). The face plate is COMPLETELY EMOTIONLESS AND BLANK - a smooth, featureless porcelain-white or pale synthetic surface with MINIMAL features: simple geometric eye sockets with soft neon blue glow, NO expressive mouth or nose details, NO human-like expressions. The face is serene, mask-like, and devoid of emotion - like a pristine mannequin or classical statue. Body construction is sleek plastic and synthetic polymers with graceful, refined proportions. " + (Math.random() > 0.5 ? "Synthetic fiber strands or smooth cap-like head design." : "Sleek synthetic hair in an elegant style.") + " The overall aesthetic is clean, minimalist, and eerily calm - more like a beautiful lifeless doll than a machine."
          : "This is a sleek synthetic android with smooth, artificial appearance rather than mechanical or robotic. This synthetic android has a humanoid form with a distinctive PURE WHITE, PALE, PORCELAIN-LIKE face plate made of 1-4 smooth panels (NO warm tones, NO golden/bronze hues - only cool white/pale colors). The face is VERY HUMAN-LIKE with realistic sculpted features: a prominent nose, defined cheekbones, subtle lips/mouth, and expressive contours that closely mimic human facial structure. The android has neon blue illuminated cybernetic eyes that glow softly. Body/armor is COOL METALLIC - silver, chrome, steel, gunmetal tones (NO golden or bronze colors). " + (Math.random() > 0.5 ? "Synthetic hair that looks remarkably real cascades from the head area." : "Sleek fiber-optic cables styled like hair strands are integrated into the head design.") + " The body is synthetic with clean panels and seamless construction - no exposed gears or obvious mechanical parts, more like a high-tech mannequin with advanced materials.");
