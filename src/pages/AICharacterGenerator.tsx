      ...
      const speciesDescription = selectedSpecies === "defective"
        ...
        ? (() => {
            ...
            const roleDescription = role === "soldier" 
              ? "This is a hardened SOLDIER adapted to underground desert life. They wear tactical gear and carry FUTURISTIC SCI-FI WEAPONS AND DEVICES that show a stark contrast between high-tech and improvised low-tech: advanced energy weapons (plasma rifles, laser pistols, electromagnetic pulse devices) alongside crude makeshift weapons (scavenged blades, pipe guns, salvaged tech). High-tech equipment includes holographic HUDs, advanced targeting systems, energy shields, powered exoskeletons, and sleek sci-fi firearms with glowing components. Low-tech elements include rusted metal armor plates, cloth wrappings, duct-taped repairs, and improvised modifications. The contrast shows survival ingenuity - combining salvaged futuristic technology with desperate makeshift solutions. Military bearing with signs of combat experience (scars, weathered look, muscular build). Equipment blend: tactical vest with both energy cells and bullet pouches, combat boots, protective gear mixing ceramics and scrap metal."
              : role === "scientist"
