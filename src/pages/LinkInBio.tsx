  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 py-12 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div
          className="absolute inset-x-0 top-0 h-[46vh] md:h-full bg-no-repeat bg-top bg-[length:100%_auto] md:bg-cover md:bg-center opacity-[0.55] dark:opacity-[0.75] saturate-[1.25]"
