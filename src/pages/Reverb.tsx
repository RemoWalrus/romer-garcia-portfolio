  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden transition-colors">
      ...
      <section
        ...
        className="relative isolate min-h-[380px] overflow-hidden border-t border-border bg-background transition-colors md:min-h-[460px]"
      >
        <img
          src={frequencyCity}
        ...
        <div className="mx-auto flex min-h-[380px] w-full max-w-[1500px] items-center px-5 pt-10 pb-16 md:min-h-[460px] md:px-8 md:pt-12 md:pb-24">
