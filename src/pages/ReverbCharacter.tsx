          ...
          >
            <div className="relative grid grid-cols-1 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.5fr)] xl:grid-cols-[minmax(0,0.64fr)_minmax(0,1.5fr)] h-full lg:min-h-[520px]">
              ...
              <div className="relative z-40 h-[70svh] min-h-[340px] overflow-visible px-5 pt-7 pb-0 md:px-8 lg:h-full lg:min-h-0 lg:pt-8">
                ...
                <div className="absolute -right-[4%] top-0 z-40 flex h-[105%] w-[82%] items-start justify-end pointer-events-none md:right-[-6%] md:w-[58%] md:h-[100%] lg:right-[-70%] lg:top-0 lg:bottom-auto lg:h-full lg:w-full lg:items-start min-[1100px]:right-[-24%] min-[1100px]:w-[92%] min-[1100px]:h-[104%] xl:right-[-64%] xl:top-[-2.5%] xl:h-[105.5%] xl:w-[110%]">
